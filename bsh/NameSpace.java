...
public class NameSpace implements java.io.Serializable
{
    ...
    */
    ...
    public static Class getClass(NameSpace namespace, String name)
    {
		...
		if( (namespace != null) && !Name.isCompound(name) )
		{
			...
			if (fullname != null) {
				...
				c=classForName(fullname,loader);
				if ( c!= null)
					return c;
	...
	static Class classForName( String name, ClassLoader loader ) {
		...
		if ( loader == null )
			loader = NameSpace.class.getClassLoader();
	...
	*/
	...
	static boolean classExists( String name ) {
		...
		*/
		...
		return ( classForName( name, null ) != null );
	}
